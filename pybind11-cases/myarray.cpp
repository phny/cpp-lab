...
void ArrayTest(const py::array_t<int64_t>& in_arr, py::array_t<int64_t>& out_arr) {
...
PYBIND11_MODULE(myarray, m) {
  ...
  py::bind_vector<std::vector<int64_t>>(m, "Vector");
  py::bind_vector<py::array_t<int64_t>>(m, "ARR");
