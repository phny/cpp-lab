...
int test_chrono_duration() {
  {
    ...
    // chrono::duration_cast: Converts the value of dtn into some other duration
    // type, taking into account differences in their periods
  ...
  {
    // duration::count: Returns the internal count (i.e., the representation
    ...
    std::cout << foo.count() * milliseconds::period::num /
  ...
  {
    // chrono::time_point_cast: Converts the value of tp into a time_point type
    // with a different duration internal object, taking into account
...
int test_chrono_high_resolution_clock() {
  // high_resolution_clock::now: Returns the current time_point in the frame of
...
int test_chrono_steady_clock() {
  ...
  // steady_clock::now: Returns the current time_point in the frame of the
  // steady_clock.
  using namespace std::chrono;
...
int test_chrono_system_clock() {
  { // system_clock::from_time_t: Converts t into its equivalent of member type
    // time_point.
    using namespace std::chrono;
  ...
  { // system_clock::now: Returns the current time_point in the frame of the
    // system_clock
    using namespace std::chrono;
...
int test_chrono_time_point() {
  ...
  { // time_point::time_since_epoch: Returns a duration object with the time
    // span value between the epoch and the time point
    using namespace std::chrono;
